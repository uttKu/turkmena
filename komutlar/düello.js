...
exports.run = async (client, message, args) => {
    ...
    const duello1 = new Discord.RichEmbed()
    .setColor('211427')
    ...
    .setTitle('Kendin ile Düello Atamazsın!')
    .setFooter('TürkMena Düello Sistemi!');
  
    const duello2 = new Discord.RichEmbed()
    .setColor('211427')
    .setAuthor("TürkMena Bot", "https://cdn.discordapp.com/icons/730079418067845232/b73d45d3506545083ccc49677cc9bf5e.png?size=128", "http://turkmena.tc/")
    .setTitle('Kanal sayısına göre savaş yapabilirsin!')
    .setFooter('TürkMena Düello Sistemi!');
  
    const duello3 = new Discord.RichEmbed()
    .setColor('211427')
    .setAuthor("TürkMena Bot", "https://cdn.discordapp.com/icons/730079418067845232/b73d45d3506545083ccc49677cc9bf5e.png?size=128", "http://turkmena.tc/")
    .setTitle('Düello!')
  ...
  this.fighting = new Set();
        ...
        if (!opponent) return message.reply(":punch: Oynamak istediğin kişiyi etiketlemelisiniz.")
  
  if (opponent.bot) return message.reply(':punch: Botlar ile düello yapamazsın dostum.');
  if (opponent.id === message.author.id) return message.channel.sendEmbed(duello1).then(msg => msg.delete(5000));
                if (this.fighting.has(message.channel.id)) return message.channel.sendEmbed(duello2).then(msg => msg.delete(5000));
                ...
                await message.channel.send(`${opponent}, düello isteği geldi. Düello'yu kabul ediyor musun? (\`evet\` veya \`hayır\` olarak cevap veriniz.)`);
                                ...
                                if (!verification) {
                                        ...
                                        return message.channel.send(`:punch: Düello kabul edilmedi...`);
                                }
                        }
                        let userHP = 500;
                        let oppoHP = 500;
